...
export default function RegisterScreen({ navigation }) {
  ...
  const [formData, setFormData] = useState({
    ...
    college: '', age: '', password: '', confirmPassword: '', address: '', classGroup: ''
  });

  const dispatch = useDispatch();
  const { isLoading, error, registerOtpSent, loginEmail, loginRole, loginPassword, registrationData } = useSelector(state => state.auth);
  ...
  const validateForm = () => {
    ...
    else if (!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(formData.email.trim())) newErrors.email = 'Invalid User ID / Email';
  ...
  const handleVerifyOTP = async () => {
    ...
    if (role === 'teacher' && !adminOtp) newErrors.adminOtp = 'Please enter the Admin OTP';
    ...
    dispatch(verifyRegisterUser({ 
      ...finalData,
      email: finalEmail.trim(), 
      role: finalRole, 
      otp, 
      adminOtp: finalRole === 'teacher' ? adminOtp : undefined 
    })).then((action) => {
                ...
                <View style={styles.rolesContainer}>
                  {roles.map((r) => {
                    ...
                    return (
                      ...
                      >
                        <Feather name={r.icon} size={20} color={isActive ? r.color : '#64748b'} />
                        <Text style={[styles.roleText, isActive && { color: 'white' }]}>{r.label}</Text>
                      </TouchableOpacity>
                    );
                  })}
                </View>
                ...
                <View style={styles.formContainer}>
                  ...
                  <View style={styles.row}>
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.name} onChangeText={(val) => handleChange('name', val)} placeholder="Name" placeholderTextColor="#64748b" />
                      </View>
                    ...
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.email} onChangeText={(val) => handleChange('email', val)} placeholder="Email" placeholderTextColor="#64748b" keyboardType="email-address" autoCapitalize="none" />
                      </View>
                  ...
                  <View style={styles.row}>
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.phone} onChangeText={(val) => handleChange('phone', val)} placeholder="Phone" placeholderTextColor="#64748b" keyboardType="numeric" />
                      </View>
                    ...
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.age} onChangeText={(val) => handleChange('age', val)} placeholder="Age" placeholderTextColor="#64748b" keyboardType="numeric" />
                      </View>
                  ...
                  <View style={styles.row}>
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        <Feather name="book" size={16} color="#64748b" style={styles.inputIcon} />
                        <TextInput style={styles.input} value={formData.department} onChangeText={(val) => handleChange('department', val)} placeholder="Dept" placeholderTextColor="#64748b" />
                      </View>
                    ...
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        <Feather name="award" size={16} color="#64748b" style={styles.inputIcon} />
                        <TextInput style={styles.input} value={formData.college} onChangeText={(val) => handleChange('college', val)} placeholder="College" placeholderTextColor="#64748b" />
                      </View>
                  ...
                  <View style={styles.row}>
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.password} onChangeText={(val) => handleChange('password', val)} placeholder="Password" placeholderTextColor="#64748b" secureTextEntry={!showPassword} />
                      </View>
                    ...
                    <View style={styles.halfInputContainer}>
                      ...
                      <View style={styles.inputBox}>
                        <Feather name="lock" size={16} color="#64748b" style={styles.inputIcon} />
                        <TextInput style={styles.input} value={formData.confirmPassword} onChangeText={(val) => handleChange('confirmPassword', val)} placeholder="Confirm" placeholderTextColor="#64748b" secureTextEntry={!showConfirmPassword} />
                      </View>
                  ...
                  <View style={styles.row}>
                    ...
                    <View style={[styles.halfInputContainer, role === 'teacher' && { width: '100%' }]}>
                      ...
                      <View style={styles.inputBox}>
                        ...
                        <TextInput style={styles.input} value={formData.address} onChangeText={(val) => handleChange('address', val)} placeholder="Address" placeholderTextColor="#64748b" />
                      </View>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('Login')} style={styles.loginLink}>
                    <Text style={styles.loginText}>Already have an account? <Text style={styles.loginTextBold}>Login here</Text></Text>
                  </TouchableOpacity>
                </View>
              </View>
            ) : (
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1 },
  scrollContent: { flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 15, paddingVertical: 40 },
  ...
  rolesContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  roleButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, marginHorizontal: 4, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 2, borderColor: 'transparent' },
  roleText: { color: '#94a3b8', fontSize: 13, fontWeight: '600', marginLeft: 8 },
  ...
  inputBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255, 255, 255, 0.05)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.1)', borderRadius: 14, height: 48 },
  ...
  serverError: { backgroundColor: 'rgba(239, 68, 68, 0.15)', borderColor: 'rgba(239, 68, 68, 0.3)', borderWidth: 1, borderRadius: 12, padding: 12, marginTop: 10 },
  serverErrorText: { color: '#f87171', fontSize: 13 },
  submitButton: { backgroundColor: '#10b981', borderRadius: 14, height: 50, justifyContent: 'center', alignItems: 'center', marginTop: 15 },
